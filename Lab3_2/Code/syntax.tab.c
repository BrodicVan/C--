...
#line 1917 "./syntax.tab.c"
  ...
  case 41: /* Stmt: CompSt  */
#line 130 "./syntax.y"
         {(yyval.type_node) = createNode((yyvsp[0].type_node)->row,Stmt,NULL,0,0);(yyval.type_node)->generation = Stmt0;addNodes((yyval.type_node),1,(yyvsp[0].type_node));}
